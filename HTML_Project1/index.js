$(document).ready(function () {
  ...
  function homePagePortalCall(inputValue = "") {
    console.log("");
    ...
    $.get(
      ...
      function (productList) {
        ...
        if (inputValue === "") {
          ...
          let newProduct = productList.filter((item) => {
  ...
  $(".search").click(function () {
    var inputString = $("#search-box").val();
    homePagePortalCall(inputString);
  });
